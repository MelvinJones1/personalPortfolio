...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      about:
        "Developed a virtual payment app, where you can send virtual money and receive from you friends.",
      learning:
  ...
  return (
    <section
      id="projects"
      className="bg-gradient-to-b from-blue-purple to-queen-pink p-8 h-screen"
    >
